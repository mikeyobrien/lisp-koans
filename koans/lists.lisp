...
(define-test how-to-make-lists
  (let (;; Literal lists can be passed by quoting them.
    ...
    (assert-equal (list (* 2 1) (* 2 2) (* 2 3)) some-evens)
    (assert-equal '(16487302 . (3826700034 . (10000000 . nil))) long-numbers)
    (assert-equal (cons "Matthew" (cons "Mark" (cons "Margaret" '()))) names)))
